...
namespace PrismTest
{
    public partial class MainWindow : Window
    {
        ...
        public void OpenImageDL(string gametitle, string searchstring, string imagetype)
        {
            ...
            DLImgType = imagetype;
            if (DialogFrame.Content.ToString() == "PrismTest.EditGames" || DialogFrame.Content.ToString() == "PrismTest.AddGames")
            {
                DialogFrame.Visibility = Visibility.Visible;
            ...
            else if (DialogFrame.Content.ToString() == "PrismTest.Views.ImageDownload")
            {
                if (dialogOpen == "edit")
                {
                    DialogFrame.Content = DialogEditGames;
        ...
        {
            Trace.WriteLine(DateTime.Now + ": Store View Active");
            StoreViewActive();
        }
